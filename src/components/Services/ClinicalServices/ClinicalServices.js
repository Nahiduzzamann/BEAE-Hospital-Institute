        ...
        <div className="bg-gray-100">
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        of an ideal hospital. BEAE Hospital is always concerned about better out-patient service. Our OPD has proper
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-gray-700 mb-4">
                    BEAE Hospital provides specialized services in various subspecialties to cater to specific eye conditions. Some of the
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        anesthesiologists operate on and care for patients in the OT. BEAE Hospital has separate OTs for septic and aseptic
